      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {TEMPLE_FACTS.map((fact) => (
            <article
              key={fact.id}
              className="group relative rounded-3xl bg-white border border-[#ebdcb9] hover:border-[#d89b18] shadow-[0_6px_25px_rgba(74,38,24,0.06)] hover:shadow-[0_16px_40px_rgba(216,155,24,0.18)] transition-all duration-300 overflow-hidden flex flex-col justify-between"
            >
              {/* Image Banner */}
